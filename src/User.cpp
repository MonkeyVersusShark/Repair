...
*/
void User::setName(std::string t_name) { this->m_name = t_name; }
...
*/
void User::setEmail(std::string t_email) { this->m_email = t_email; }
...
*/
void User::setPhone(std::string t_phone) { this->m_phone = t_phone; }
